...
{
  {
    ...
    .pFctSetADCSampPointSect1          = &R1VL1_CalcDutyCycles,     
    .pFctSetADCSampPointSect2          = &R1VL1_CalcDutyCycles,     
    .pFctSetADCSampPointSect3          = &R1VL1_CalcDutyCycles,     
    .pFctSetADCSampPointSect4          = &R1VL1_CalcDutyCycles,     
    .pFctSetADCSampPointSect5          = &R1VL1_CalcDutyCycles,     
    .pFctSetADCSampPointSect6          = &R1VL1_CalcDutyCycles,           
